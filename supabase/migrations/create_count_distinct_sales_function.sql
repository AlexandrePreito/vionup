-- Função RPC para contar vendas distintas (COUNT DISTINCT de venda_id)
...
COMMENT ON FUNCTION count_distinct_sales IS 'Conta o número de venda_ids distintos na tabela external_sales para um grupo de empresas e período específico';
