...
export const NAV_MODULES: NavModule[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { route: '/empresas', label: 'Empresas (Cadastro)', display_order: 2 },
  ...
  },
  {
    ...
    display_order: 3,
    pages: [
      { route: '/powerbi/conexoes', label: 'Conexões Power BI', display_order: 1 },
      { route: '/powerbi/sincronizacao', label: 'Sincronização Power BI', display_order: 2 },
    ],
  },
  {
    name: 'compras',
  ...
  },
  {
    ...
    display_order: 6,
    pages: [
      { route: '/dashboard/nps_interno', label: 'NPS (Interno)', display_order: 1 },
      { route: '/dashboard-financeiro', label: 'Financeiro', display_order: 2 },
      { route: '/dashboard/realizado', label: 'Realizado', display_order: 3 },
      { route: '/dashboard/realizado-mes', label: 'Realizado por Mês', display_order: 4 },
      { route: '/dashboard/previsao', label: 'Previsão de Vendas', display_order: 5 },
      { route: '/dashboard/empresas', label: 'Metas Empresas', display_order: 6 },
      { route: '/dashboard/empresa', label: 'Meta Empresa', display_order: 7 },
      { route: '/dashboard/equipe', label: 'Equipe', display_order: 8 },
      { route: '/dashboard/funcionario', label: 'Funcionário', display_order: 9 },
      { route: '/dashboard/nps', label: 'Dashboard NPS (Goomer)', display_order: 10 },
      { route: '/dashboard/importar', label: 'Importar Dados', display_order: 11 },
    ],
  },
  {
    name: 'nps',
    ...
    display_order: 7,
    pages: [
      { route: '/nps', label: 'Dashboard NPS', display_order: 1 },
      ...
      { route: '/nps/configuracoes', label: 'Configurações NPS', display_order: 6 },
    ],
  },
];
